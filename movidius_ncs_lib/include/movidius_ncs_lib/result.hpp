...
#ifndef MOVIDIUS_NCS_LIB__RESULT_HPP_
#define MOVIDIUS_NCS_LIB__RESULT_HPP_
...
public:
  ...
  void parseYoloResult(
    const std::vector<float> & result, const std::vector<std::string> categories,
...
#endif  // MOVIDIUS_NCS_LIB__RESULT_HPP_
