...
#ifndef MOVIDIUS_NCS_LIB_NCS_MANAGER_HPP_
#define MOVIDIUS_NCS_LIB_NCS_MANAGER_HPP_
...
{
typedef boost::function<void(ClassificationResultPtr result, std_msgs::msg::Header header)> FUNP_C;
typedef boost::function<void(DetectionResultPtr result, std_msgs::msg::Header header)> FUNP_D;
...
#endif  // MOVIDIUS_NCS_LIB_NCS_MANAGER_HPP_
