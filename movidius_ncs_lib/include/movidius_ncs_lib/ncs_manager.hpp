...
#ifndef MOVIDIUS_NCS_LIB__NCS_MANAGER_HPP_
#define MOVIDIUS_NCS_LIB__NCS_MANAGER_HPP_
...
{
typedef boost::function<void (ClassificationResultPtr result,
    std_msgs::msg::Header header)>
  FUNP_C;
typedef boost::function<void (DetectionResultPtr result,
    std_msgs::msg::Header header)>
  FUNP_D;
...
public:
  NCSManager(
    const int & max_device_number, const int & device_index,
  ...
  void detectStream(
    ...
    const sensor_msgs::msg::Image::SharedPtr & image_msg);
  std::vector<ClassificationResultPtr> classifyImage(
    const std::vector<std::string> & images);
  std::vector<DetectionResultPtr> detectImage(
    const std::vector<std::string> & images);
...
#endif  // MOVIDIUS_NCS_LIB__NCS_MANAGER_HPP_
