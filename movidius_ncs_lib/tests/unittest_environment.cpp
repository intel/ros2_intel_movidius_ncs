...
TEST(UnitTestEnvironment, testSDK) {
  std::system("python2 /opt/movidius/NCSDK/tests/api-check/ncs-python2-check.py > "
...
TEST(UnitTestEnvironment, testAppZoo) {
  ...
  std::vector<std::string> caffe_dirs = {"AlexNet", "GoogLeNet", "SqueezeNet",
    "SSD_MobileNet", "TinyYolo"};
  std::vector<std::string> tf_dirs = {"inception_v1", "inception_v2", "inception_v3",
    "inception_v4", "mobilenets/model"};
